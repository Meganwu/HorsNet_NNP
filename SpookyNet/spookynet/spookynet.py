...
class SpookyNet(nn.Module):
    ...
    def __init__(
        ...
        self.output_q = nn.Linear(1, 1, bias=True)
    ...
    def _atomic_properties_dynamic(
        ...
        qa_2 = self.output_q(qa.unsqueeze(1)).squeeze(-1)
        ...
        return (f, ea, qa, ea_rep, ea_ele, ea_vdw, pa, c6, qa_2)
    ...
    def energy(
        ...
        if batch_seg is None:  # assume a single batch
            batch_seg = Z.new_zeros(Z.size(0))
        (f, ea, qa, ea_rep, ea_ele, ea_vdw, pa, c6, qa_2) = self.atomic_properties(
            Z=Z,
            Q=Q,
            S=S,
            R=R,
        ...
        return (energy, f, ea, qa, ea_rep, ea_ele, ea_vdw, pa, c6, qa_2)
    ...
    def energy_and_forces(
        ...
        Returns:
            ...
            (+ all return values of atomic_properties)
        """
        (energy, f, ea, qa, ea_rep, ea_ele, ea_vdw, pa, c6, qa_2) = self.energy(
            Z=Z,
            Q=Q,
            S=S,
            R=R,
        ...
        if idx_i.numel() > 0:  # autograd will fail if there are no distances
            ...
            forces = torch.zeros_like(R)
        return (energy, forces, f, ea, qa, ea_rep, ea_ele, ea_vdw, pa, c6, qa_2)
    ...
    def energy_and_forces_and_hessian(
        ...
        return energy, forces, hessian, f, ea, qa, ea_rep, ea_ele, ea_vdw, pa, c6, qa_2
    ...
    def forward(
        ...
        return energy, forces, dipole, f, ea, qa, ea_rep, ea_ele, ea_vdw, pa, c6, qa_2
