...
from utils.torch_geometric.utils import download_url, extract_zip
...
from utils.batch_ops import bincount
from utils.regressor import solver
from utils.savenload import atomic_write
from utils.multiprocessing import num_tasks
...
class ASEDataset(AtomicInMemoryDataset):
    ...
    def get_data(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            from utils._global_options import _get_latest_global_options
