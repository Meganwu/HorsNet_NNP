...
from utils.torch_geometric import Data
...
_DEFAULT_LONG_FIELDS: Set[str] = {
    ...
    AtomicDataDict.NUM_ELEMENT_TYPE_KEY, 
    ...
    def from_ase(
        ...
        **kwargs,
        ...
        Returns:
            A ``AtomicData``.
        """
        from ase_utils import NequIPCalculator
        ...
        try:
            add_fields[AtomicDataDict.PER_ATOM_CHARGE_KEY] = atoms.get_initial_charges()
            add_fields[AtomicDataDict.TOTAL_CHARGE_KEY] = np.zeros([1])
        except:
            pass
