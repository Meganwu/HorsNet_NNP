...
from nn._atomwise_nian import AtomwiseLinearFinal
...
from nn.modules import NuclearEmbedding
...
def EnergyModel(
    ...
    layers = {
     ...
     #   "one_hot": NuclearEmbedding(32, zero_init=False),
     #   "one_hot": (NuclearEmbedding, dict(num_features=32)),
    ...
    # nian_modify add attention layer
    ...
    layers.update(
        {
            ...
            "output_hidden_to_scalar": (
                AtomwiseLinearFinal,
                dict(irreps_out="2x0e", out_field_1=AtomicDataDict.PER_ATOM_ENERGY_KEY, out_field_2=AtomicDataDict.PER_CHARGE_KEY),
            ),
        }
    )
